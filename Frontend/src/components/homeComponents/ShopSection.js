...
const ShopSection = () => {
  ...
  const getFilterList = () => {
    if (!selectedCategory) {
      return context.searchProducts;
    }
    return context.searchProducts.filter(
              ...
              <div className=" mb-4 mx-3">
                <header className="card-top">
                  <div className="row gx-3 py-3">
                    <div className="col-lg-4 col-md-6 me-auto py-1"></div>
                ...
                {loading ? (
                  ...
                  <>
                    {currentProducts.map((product) => (
                      ...
                      >
                        <div
                          className="border-product d-flex align-items-start justify-content-center "
                          data-aos="fade-up"
                        >
                          <Link to={`/products/${product._id}`}>
                            <div className="shopBack-wrapper ">
                              <div
                                className="shopBack"
                                style={{
                                  width: '100%',
